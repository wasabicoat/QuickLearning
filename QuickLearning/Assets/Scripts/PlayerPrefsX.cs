...
// Modified by Jean fabre 22 may 2013
// -- added Rect support ( not for arrays yet )
...
public static bool SetRect (String key, Rect rect)
{
	return SetFloatArray(key, new float[]{rect.x, rect.y, rect.width, rect.height});
}
